 ...
 * IO pins assignments.
 */
#define GPIOA_LCD_DATA              0U
#define GPIOA_LCD_NRESET            1U
 ...
 * GPIOA setup:
 *
 * PA0  - LCD_DATA                  (output pp).
 * PA1  - LCD_NRESET                (output pp).
 * PA2  - USART_TX                  (alternate 7).
 * PA3  - USART_RX                  (alternate 7).
 * PA4  - SPI1_NSS                  (output pp; software SS).
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(GPIOA_LCD_DATA) |           \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_NRESET) |           \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_LCD_DATA) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_NRESET) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_50M(GPIOA_LCD_DATA) |          \
                                     PIN_OSPEED_50M(GPIOA_LCD_NRESET) |          \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_LCD_DATA) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_NRESET) |         \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_LCD_DATA) |             \
                                     PIN_ODR_LOW(GPIOA_LCD_NRESET) |             \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_LCD_DATA, 0) |           \
                                     PIN_AFIO_AF(GPIOA_LCD_NRESET, 0) |           \
