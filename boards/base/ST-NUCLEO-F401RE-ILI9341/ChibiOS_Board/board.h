...
#define GPIOA_LCD_RD                0U
#define GPIOA_LCD_WR                1U
#define GPIOA_TOUCH_YIN             1U
#define GPIOA_TOUCH_YP              1U
#define GPIOA_USART_TX              2U
#define GPIOA_USART_RX              3U
#define GPIOA_LCD_RS                4U
#define GPIOA_TOUCH_XIN             4U
#define GPIOA_TOUCH_XM              4U
#define GPIOA_LED_GREEN             5U
#define GPIOA_PIN6                  6U
#define GPIOA_PIN7                  7U
#define GPIOA_LCD_D7                8U
#define GPIOA_TOUCH_YM              8U
#define GPIOA_LCD_D0                9U
#define GPIOA_LCD_D2                10U
...
#define GPIOB_LCD_CS                0U
#define GPIOB_PIN1                  1U
#define GPIOB_PIN2                  2U
#define GPIOB_LCD_D3                3U
#define GPIOB_LCD_D5                4U
#define GPIOB_LCD_D4                5U
#define GPIOB_PIN6                  6U
#define GPIOB_PIN7                  7U
#define GPIOB_PIN8                  8U
#define GPIOB_PIN9                  9U
#define GPIOB_LCD_D6                10U
#define GPIOB_TOUCH_XP              10U
...
#define GPIOC_LCD_RST               1U
#define GPIOC_PIN2                  2U
#define GPIOC_PIN3                  3U
#define GPIOC_PIN4                  4U
#define GPIOC_PIN5                  5U
#define GPIOC_PIN6                  6U
#define GPIOC_LCD_D1                7U
 ...
 * GPIOA setup:
 *
 * PA0  - LCD_RD                    (output pushpull high).
 * PA1  - LCD_WR                    (output pushpull high).
 * PA2  - USART_TX                  (alternate 7).
 * PA3  - USART_RX                  (alternate 7).
 * PA4  - LCD_RS                    (output pushpull high).
 * PA5  - LED_GREEN                 (output pushpull low).
 * PA6  - PIN6                      (input pullup).
 * PA7  - PIN7                      (input pullup).
 * PA8  - LCD_D7                    (output pushpull high).
 * PA9  - LCD_D0                    (output pushpull high).
 * PA10 - LCD_D2                    (output pushpull high).
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(GPIOA_LCD_RD) |        \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_WR) |        \
                                     PIN_MODE_ALTERNATE(GPIOA_USART_TX) |   \
                                     PIN_MODE_ALTERNATE(GPIOA_USART_RX) |   \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_RS) |        \
                                     PIN_MODE_OUTPUT(GPIOA_LED_GREEN) |     \
                                     PIN_MODE_INPUT(GPIOA_PIN6) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN7) |           \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_D7) |        \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_D0) |        \
                                     PIN_MODE_OUTPUT(GPIOA_LCD_D2) |        \
                                     PIN_MODE_ALTERNATE(GPIOA_OTG_FS_DM) |  \
                                     PIN_MODE_ALTERNATE(GPIOA_OTG_FS_DP) |  \
                                     PIN_MODE_ALTERNATE(GPIOA_SWDIO) |      \
                                     PIN_MODE_ALTERNATE(GPIOA_SWCLK) |      \
                                     PIN_MODE_INPUT(GPIOA_PIN15))
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_LCD_RD) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_WR) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_USART_TX) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_USART_RX) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_RS) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LED_GREEN) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN6) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN7) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_D7) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_D0) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_LCD_D2) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_OTG_FS_DM) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_OTG_FS_DP) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWDIO) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWCLK) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN15))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_100M(GPIOA_LCD_RD) |        \
                                     PIN_OSPEED_100M(GPIOA_LCD_WR) |        \
                                     PIN_OSPEED_50M(GPIOA_USART_TX) |       \
                                     PIN_OSPEED_50M(GPIOA_USART_RX) |       \
                                     PIN_OSPEED_100M(GPIOA_LCD_RS) |        \
                                     PIN_OSPEED_50M(GPIOA_LED_GREEN) |      \
                                     PIN_OSPEED_100M(GPIOA_PIN6) |          \
                                     PIN_OSPEED_100M(GPIOA_PIN7) |          \
                                     PIN_OSPEED_100M(GPIOA_LCD_D7) |        \
                                     PIN_OSPEED_100M(GPIOA_LCD_D0) |        \
                                     PIN_OSPEED_100M(GPIOA_LCD_D2) |        \
                                     PIN_OSPEED_100M(GPIOA_OTG_FS_DM) |     \
                                     PIN_OSPEED_100M(GPIOA_OTG_FS_DP) |     \
                                     PIN_OSPEED_100M(GPIOA_SWDIO) |         \
                                     PIN_OSPEED_100M(GPIOA_SWCLK) |         \
                                     PIN_OSPEED_100M(GPIOA_PIN15))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_LCD_RD) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_WR) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_USART_TX) |   \
                                     PIN_PUPDR_FLOATING(GPIOA_USART_RX) |   \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_RS) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_LED_GREEN) |  \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN6) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN7) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_D7) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_D0) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_LCD_D2) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_OTG_FS_DM) |  \
                                     PIN_PUPDR_FLOATING(GPIOA_OTG_FS_DP) |  \
                                     PIN_PUPDR_PULLUP(GPIOA_SWDIO) |        \
                                     PIN_PUPDR_PULLDOWN(GPIOA_SWCLK) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN15))
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_LCD_RD) |           \
                                     PIN_ODR_HIGH(GPIOA_LCD_WR) |           \
                                     PIN_ODR_HIGH(GPIOA_USART_TX) |         \
                                     PIN_ODR_HIGH(GPIOA_USART_RX) |         \
                                     PIN_ODR_HIGH(GPIOA_LCD_RS) |           \
                                     PIN_ODR_LOW(GPIOA_LED_GREEN) |         \
                                     PIN_ODR_HIGH(GPIOA_PIN6) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN7) |             \
                                     PIN_ODR_HIGH(GPIOA_LCD_D7) |           \
                                     PIN_ODR_HIGH(GPIOA_LCD_D0) |           \
                                     PIN_ODR_HIGH(GPIOA_LCD_D2) |           \
                                     PIN_ODR_HIGH(GPIOA_OTG_FS_DM) |        \
                                     PIN_ODR_HIGH(GPIOA_OTG_FS_DP) |        \
                                     PIN_ODR_HIGH(GPIOA_SWDIO) |            \
                                     PIN_ODR_HIGH(GPIOA_SWCLK) |            \
                                     PIN_ODR_HIGH(GPIOA_PIN15))
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_LCD_RD, 0) |         \
                                     PIN_AFIO_AF(GPIOA_LCD_WR, 0) |         \
                                     PIN_AFIO_AF(GPIOA_USART_TX, 7) |       \
                                     PIN_AFIO_AF(GPIOA_USART_RX, 7) |       \
                                     PIN_AFIO_AF(GPIOA_LCD_RS, 0) |         \
                                     PIN_AFIO_AF(GPIOA_LED_GREEN, 0) |      \
                                     PIN_AFIO_AF(GPIOA_PIN6, 0) |           \
                                     PIN_AFIO_AF(GPIOA_PIN7, 0))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_LCD_D7, 0) |         \
                                     PIN_AFIO_AF(GPIOA_LCD_D0, 0) |         \
                                     PIN_AFIO_AF(GPIOA_LCD_D2, 0) |         \
 ...
 * GPIOB setup:
 *
 * PB0  - LCD_CS                    (output pushpull high).
 * PB1  - PIN1                      (input pullup).
 * PB2  - PIN2                      (input pullup).
 * PB3  - LCD_D3                    (output pushpull high).
 * PB4  - LCD_D5                    (output pushpull high).
 * PB5  - LCD_D4                    (output pushpull high).
 * PB6  - PIN6                      (input pullup).
 * PB7  - PIN7                      (input pullup).
 * PB8  - PIN8                      (input pullup).
 * PB9  - PIN9                      (input pullup).
 * PB10 - LCD_D6                    (output pushpull high).
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_LCD_CS) |        \
                                     PIN_MODE_INPUT(GPIOB_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN2) |           \
                                     PIN_MODE_OUTPUT(GPIOB_LCD_D3) |        \
                                     PIN_MODE_OUTPUT(GPIOB_LCD_D5) |        \
                                     PIN_MODE_OUTPUT(GPIOB_LCD_D4) |        \
                                     PIN_MODE_INPUT(GPIOB_PIN6) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN7) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN8) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN9) |           \
                                     PIN_MODE_OUTPUT(GPIOB_LCD_D6) |        \
                                     PIN_MODE_INPUT(GPIOB_PIN11) |          \
                                     PIN_MODE_INPUT(GPIOB_PIN12) |          \
                                     PIN_MODE_INPUT(GPIOB_PIN13) |          \
                                     PIN_MODE_INPUT(GPIOB_PIN14) |          \
                                     PIN_MODE_INPUT(GPIOB_PIN15))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_LCD_CS) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_LCD_D3) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_LCD_D5) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_LCD_D4) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN6) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN7) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN8) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN9) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_LCD_D6) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN11) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN12) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN13) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN14) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN15))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_100M(GPIOB_LCD_CS) |        \
                                     PIN_OSPEED_100M(GPIOB_PIN1) |          \
                                     PIN_OSPEED_100M(GPIOB_PIN2) |          \
                                     PIN_OSPEED_100M(GPIOB_LCD_D3) |        \
                                     PIN_OSPEED_100M(GPIOB_LCD_D5) |        \
                                     PIN_OSPEED_100M(GPIOB_LCD_D4) |        \
                                     PIN_OSPEED_100M(GPIOB_PIN6) |          \
                                     PIN_OSPEED_100M(GPIOB_PIN7) |          \
                                     PIN_OSPEED_100M(GPIOB_PIN8) |          \
                                     PIN_OSPEED_100M(GPIOB_PIN9) |          \
                                     PIN_OSPEED_100M(GPIOB_LCD_D6) |        \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_LCD_CS) |     \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN2) |         \
                                     PIN_PUPDR_FLOATING(GPIOB_LCD_D3) |     \
                                     PIN_PUPDR_FLOATING(GPIOB_LCD_D5) |     \
                                     PIN_PUPDR_FLOATING(GPIOB_LCD_D4) |     \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN6) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN7) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN8) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN9) |         \
                                     PIN_PUPDR_FLOATING(GPIOB_LCD_D6) |     \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN11) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN12) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN13) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN14) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN15))
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_LCD_CS) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN1) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOB_LCD_D3) |           \
                                     PIN_ODR_HIGH(GPIOB_LCD_D5) |           \
                                     PIN_ODR_HIGH(GPIOB_LCD_D4) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN6) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN7) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN8) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN9) |             \
                                     PIN_ODR_HIGH(GPIOB_LCD_D6) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN11) |            \
                                     PIN_ODR_HIGH(GPIOB_PIN12) |            \
                                     PIN_ODR_HIGH(GPIOB_PIN13) |            \
                                     PIN_ODR_HIGH(GPIOB_PIN14) |            \
                                     PIN_ODR_HIGH(GPIOB_PIN15))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_LCD_CS, 0) |         \
                                     PIN_AFIO_AF(GPIOB_PIN1, 0) |           \
                                     PIN_AFIO_AF(GPIOB_PIN2, 0) |           \
                                     PIN_AFIO_AF(GPIOB_LCD_D3, 0) |         \
                                     PIN_AFIO_AF(GPIOB_LCD_D5, 0) |         \
                                     PIN_AFIO_AF(GPIOB_LCD_D4, 0) |         \
                                     PIN_AFIO_AF(GPIOB_PIN6, 0) |           \
                                     PIN_AFIO_AF(GPIOB_PIN7, 0))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_PIN8, 0) |           \
                                     PIN_AFIO_AF(GPIOB_PIN9, 0) |           \
                                     PIN_AFIO_AF(GPIOB_LCD_D6, 0) |         \
 ...
 * PC1  - LCD_RST                   (output pushpull low).
 * PC2  - PIN2                      (input pullup).
 * PC3  - PIN3                      (input pullup).
 * PC4  - PIN4                      (input pullup).
 * PC5  - PIN5                      (input pullup).
 * PC6  - PIN6                      (input pullup).
 * PC7  - LCD_D1                    (output pushpull high).
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_LCD_D1) |     \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PIN0) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_LCD_D1) |     \
